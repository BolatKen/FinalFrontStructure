...
// export default function Welcome({ product, scrollToConfigurator }: WelcomeProps) {
//   // Состояния (оставляем только нужные)
//   const [selectedView, setSelectedView] = useState<"gallery" | "3d">("gallery");
//   const [currentImageIndex, setCurrentImageIndex] = useState(0);
//   const [isMobile, setIsMobile] = useState(false);
//   const [isModalOpen, setIsModalOpen] = useState(false);
...
//   // Галерея изображений с защитой от undefined
...
//           {/* Галерея/3D переключение */}
//           {selectedView === "gallery" && (
//             <>
//               {!isMobile && <Arrow onClick={handlePrevImage} />}
//               <div className={`${styles.welcome__container} _container`}>
...
//                   width={600}
//                   height={400}
//                   onClick={() => setModalImage(galleryImages[currentImageIndex])}
//                 />
//               </div>
//               {!isMobile && <Arrow direction="right" onClick={handleNextImage} />}
//             </>
//           )}
...
//       {/* Блок цены - теперь просто передаем base_price */}
//       <div className={styles.welcome__price}>
//         <div className={`_container ${styles.configure}`}>
//           <WelcomePrice 
//             product={product}
...
//           <img src={modalImage!} alt="Увеличенное изображение" className={styles.modalImage} />
//         </div>
//       )}
//     </main>
//   );
